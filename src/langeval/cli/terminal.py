"""
MIT License
https://github.com/pypa/hatch/blob/master/src/hatch/cli/terminal.py
"""
...
class Terminal:
    def __init__(self, verbosity, enable_color: Optional[bool], interactive: bool):
    ...
    def kv_separator(self) -> Style:
        return self.style_warning("->")  # type: ignore
    ...
    def display_header(self, title="", *, stderr=False):  # noqa: ARG002
    ...
    def status(self) -> BorrowedStatus:
        return BorrowedStatus(
            ...
            success_style=self._style_level_success,  # type: ignore
    ...
    def _output(self, text="", style=None, *, stderr=False, indent=None, link=None, **kwargs):
        ...
        if link:
            style = style.update_link(self.platform.format_file_uri(link))  # type: ignore
